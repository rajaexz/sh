...
class EditSkillController extends GetxController {
  ...
  void prefillData(){
    selectedSkill = FilterDatum(
      isSelected: false,
      id: model!.jobSkillId,
      value: model!.jobSkillName
    );
    selectedExpModel = FilterDatum(
        isSelected: false,
        id: model!.jobExperienceId,
        value: model!.asJobExperienceName
    );

    skillController!.text = model!.jobSkillName!;
