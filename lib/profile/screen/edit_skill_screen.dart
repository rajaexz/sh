...
import 'package:school_hiring/profile/controller/edit_skill_controller.dart';
...
class EditSkillScreen extends GetView<EditSkillController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<EditSkillController>(
        init: controller,
...
class AddSkillJobView extends StatelessWidget {
  final EditSkillController? controller;
